...
<body>
    ...
    <div class="container text-center mt-4 mb-4">
        <h2>REGISTRO</h2>
        <p>Ingresa tus datos para registrarlo en el sistema</p>
    </div>
    ...
    <div class="container">
        ...
        <form action="registrando.php" method="POST" >
            ...
            <div class="form-group">
                ...
                <input id="pass1" name="pass" class="form-control" type="password" minlength="8" required>
                
                <div class="ojo">
                    <i id="icon1" class="bx bx-show-alt"></i>
                </div>
            ...
            <div class="form-group">
                ...
                <input id="pass2" name="pass" class="form-control" type="password" minlength="8" required>
                
                <div class="ojo">
                    <i id="icon2" class="bx bx-show-alt"></i>
                </div>
            ...
            <p class="text-center">¿Ya tienes una cuenta?? <strong> <ins> <a href="login.php">¡Ingresar Ahora!</a> </ins> </strong> </p>
